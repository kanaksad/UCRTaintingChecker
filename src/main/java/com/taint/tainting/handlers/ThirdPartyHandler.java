...
public class ThirdPartyHandler extends AbstractHandler {
  ...
  public ThirdPartyHandler(XTaintingAnnotatedTypeFactory typeFactory) {
    super(typeFactory);
  }
  ...
  public static boolean checkHeuristicApplicability(
      MethodInvocationTree tree, XTaintingAnnotatedTypeFactory factory) {
  ...
  public static boolean polyOrUntaintedParameter(
      ExpressionTree argument, XTaintingAnnotatedTypeFactory typeFactory) {
