...
import com.taint.tainting.handlers.ThirdPartyHandler;
import com.taint.tainting.serialization.SerializationService;
...
@SupportedOptions({
  XTaintingChecker.ANNOTATED_PACKAGES,
  XTaintingChecker.ENABLE_LIBRARY_CHECKER,
  XTaintingChecker.ENABLE_VALIDATION_CHECKER,
  XTaintingChecker.ENABLE_SIDE_EFFECT,
  XTaintingChecker.ENABLE_POLY_TAINT_INFERENCE,
  XTaintingChecker.ENABLE_TYPE_ARGUMENT_INFERENCE,
  Config.SERIALIZATION_CONFIG_PATH,
  Config.SERIALIZATION_ACTIVATION_FLAG,
})
public class XTaintingChecker extends AccumulationChecker {
  ...
  private XTaintingAnnotatedTypeFactory typeFactory;
  private boolean serialize = true;
  private FoundRequired pair = null;

  public XTaintingChecker() {}

  @Override
  public void initChecker() {
    super.initChecker();
    this.serializationService = new SerializationService(this);
    this.typeFactory = (XTaintingAnnotatedTypeFactory) getTypeFactory();
  }
