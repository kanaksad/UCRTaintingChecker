package com.taint.tainting.serialization;

import static com.taint.tainting.serialization.Utility.getAnnotatedTypeMirrorOfTypeArgumentAt;
...
public class SerializationService {
   ...
   */
  private final XTaintingAnnotatedTypeFactory typeFactory;
  /** Using checker instance. */
  private final XTaintingChecker checker;
  ...
  public SerializationService(XTaintingChecker checker) {
    this.checker = checker;
    this.serializer = new Serializer(checker);
    this.typeFactory = (XTaintingAnnotatedTypeFactory) checker.getTypeFactory();
