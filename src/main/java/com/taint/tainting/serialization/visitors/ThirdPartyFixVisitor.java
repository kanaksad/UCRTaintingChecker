...
public class ThirdPartyFixVisitor extends SpecializedFixComputer {
   ...
   * Do not use or change {@link XTaintingAnnotatedTypeFactory#makeUntainted} method.
   *
   * @param type The type to make untainted.
   * @param factory The type factory.
   */
  private void makeUntainted(AnnotatedTypeMirror type, XTaintingAnnotatedTypeFactory factory) {
