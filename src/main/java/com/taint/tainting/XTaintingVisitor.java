...
/** Visitor for the {@link XTaintingChecker}. */
public class XTaintingVisitor extends AccumulationVisitor {

  /**
   * Creates a {@link XTaintingVisitor}.
   *
   * @param checker the checker that uses this visitor
   */
  public XTaintingVisitor(BaseTypeChecker checker) {
    super(checker);
  }
