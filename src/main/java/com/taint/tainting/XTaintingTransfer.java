...
public class XTaintingTransfer extends AccumulationTransfer {
  private final XTaintingAnnotatedTypeFactory aTypeFactory;

  public XTaintingTransfer(XTaintingAnalysis analysis) {
    super(analysis);
    aTypeFactory = (XTaintingAnnotatedTypeFactory) analysis.getTypeFactory();
  }
